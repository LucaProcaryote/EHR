...
#
#   https://my-hospital-ehr.procaryote.com/?backend=restApi&api=https://lab-api.example
#
# Requires: the Firebase CLI, and `firebase login` (once).
set -euo pipefail

TARGET="ehr"
SITE="my-hospital-2026-ehr"
...
DOMAIN="my-hospital-ehr.procaryote.com"
...
echo "Building EHR for the web (backend: $BACKEND, auth: $AUTH)..."
